...
// SeekCommandTestMocker.createMockCommandEventWithTime(stringArgumentCaptor,
...
//        assertEquals(String.format(TextChannelResponses.SEEKING_TO_INFORMATION,
// TimeUtils.timeString(10922)),
...
//
//        CommandEvent mockCommandEvent =
// SeekCommandTestMocker.createMockCommandEventThatFailsWithTime(stringArgumentCaptor,
//                "3:4:5:6");
//
//        SeekCommand seekCommand = new SeekCommand();
//        seekCommand.execute(mockCommandEvent);
...
//        SeekCommand seekCommand = new SeekCommand();
//        seekCommand.execute(mockCommandEvent);
//        assertEquals(TextChannelResponses.SEEK_POINT_LONGER_THAN_SONG,
// stringArgumentCaptor.getValue());
//    }
//
//    @Test
...
// TextChannelResponses.BOT_NOT_CONNECTED_TO_VOICE);
//    }
// }
