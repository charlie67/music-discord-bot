...
// {
//    public static CommandEvent createMockCommandEventWhereBotNotConnected(ArgumentCaptor<String>
...
//    }
//
//    public static CommandEvent createMockCommandEventWithTime(ArgumentCaptor<String>
// stringArgumentCaptor,
//                                                              ArgumentCaptor<Long>
// longArgumentCaptor,
//                                                              String timeArgument)
...
//        doAnswer(invocation ->
// null).when(mockAudioTrack).setPosition(longArgumentCaptor.capture());
...
//    }
//
//    public static CommandEvent createMockCommandEventThatFailsWithTime(ArgumentCaptor<String>
// stringArgumentCaptor,
//                                                                       String timeArgument)
//    {
//        MessageAction mockMessageAction = mock(MessageAction.class);
...
//    }
//
//    public static CommandEvent createMockCommandEventThatFailsSongTooLong(ArgumentCaptor<String>
// stringArgumentCaptor,
//                                                                          String timeArgument)
//    {
//        MessageAction mockMessageAction = mock(MessageAction.class);
...
//    }
//
//    public static CommandEvent
// createMockCommandEventThatFailsSongNotSeekable(ArgumentCaptor<String> stringArgumentCaptor,
//                                                                              String timeArgument)
//    {
//        MessageAction mockMessageAction = mock(MessageAction.class);
//        doAnswer(invocation -> null).when(mockMessageAction).queue();
