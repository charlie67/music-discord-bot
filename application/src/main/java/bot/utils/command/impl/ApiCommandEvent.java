...
public class ApiCommandEvent implements CommandEvent
{
    ...
    public ApiCommandEvent(User user, TextChannel textChannel, MessageChannel messageChannel,
                           PrivateChannel privateChannel, Message message, Member member, JDA jda, Guild guild,
                           ChannelType channelType, String args, CommandClient commandClient)
    {
        this.user = user;
