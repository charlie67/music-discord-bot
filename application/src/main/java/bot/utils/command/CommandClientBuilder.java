...
public class CommandClientBuilder {
  ...
  /**
   * This method has been deprecated as the new(ish) ratelimit system is more complex than we'd like
   * to implement in JDA-Utils. Considering using some other library which correctly handles the
   * ratelimits for this service.
   *
   ...
   * com.jagrosh.jdautilities.commons.utils.FixedSizeCache FixedSizeCache} used for caching and
