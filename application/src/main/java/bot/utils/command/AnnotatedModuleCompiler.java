...
/**
 * A "compiler" for {@link java.lang.Object Object}s that uses {@link
 * java.lang.annotation.Annotation Annotation}s as helpers for creating {@link
 ...
 *
 * <p>Since 1.6 the introduction of {@link bot.utils.command.CommandBuilder CommandBuilder} has
 * allowed the potential to create unique {@link bot.utils.command.Command Command} objects after
 * compilation. <br>
...
public interface AnnotatedModuleCompiler {
  /**
   * Compiles one or more {@link bot.utils.command.Command Command}s using method annotations as for
   * properties from the specified {@link java.lang.Object Object}.
   *
   * <p><b>This Object must be annotated with {@link
   * bot.utils.command.annotation.JDACommand.Module @JDACommand.Module}!</b>
   *
