...
import bot.utils.command.Command.Category;
...
/**
 * A chain-setter based builder for {@link bot.utils.command.Command Commands}.
 *
 ...
 * bot.utils.command.CommandClient#addCommand(Command) CommandClient#addCommand(Command)}.
 *
...
public class CommandBuilder {
	...
	/**
	 * Sets the {@link bot.utils.command.Command#name name} of the Command built from this
	 * CommandBuilder.
	 *
	...
	/**
	 * Sets the {@link bot.utils.command.Command#help help} snippet of the Command built from this
	 * CommandBuilder.
	 *
	...
	/**
	 * Sets the {@link bot.utils.command.Command#category category} of the Command built from this
	 * CommandBuilder.
	 *
	...
	/**
	 * Sets the {@link bot.utils.command.Command#arguments arguments} of the Command built from this
	 * CommandBuilder.
	 *
	...
	/**
	 * Sets the Command built to be {@link bot.utils.command.Command#guildOnly guild only}.
	 *
	...
	/**
	 * Sets the name of a {@link bot.utils.command.Command#requiredRole required role} to use the
	...
	/**
	 * Sets the Command built to be {@link bot.utils.command.Command#ownerCommand owner only}.
	 *
	...
	/**
	 * Sets the {@link bot.utils.command.Command#cooldown cooldown} of the Command built from this
	 * CommandBuilder.
	 *
	...
	/**
	 * Sets the {@link bot.utils.command.Command#userPermissions required user permissions} of the
	 * Command built from this CommandBuilder.
	 *
	...
	/**
	 * Sets the {@link bot.utils.command.Command#botPermissions required bot permissions} of the
	 * Command built from this CommandBuilder.
	 *
	...
	/**
	 * Adds a {@link bot.utils.command.Command#aliases alias} for the Command built from this
	 * CommandBuilder.
	 *
	...
	/**
	 * Adds {@link bot.utils.command.Command#aliases aliases} for the Command built from this
	 * CommandBuilder.
	 *
	...
	/**
	 * Sets the {@link bot.utils.command.Command#aliases aliases} of the Command built from this
	 * CommandBuilder.
	 *
	...
	/**
	 * Adds a {@link bot.utils.command.Command#children child} Command to the Command built from this
	 * CommandBuilder.
	 *
	...
	/**
	 * Adds {@link bot.utils.command.Command#children child} Commands to the Command built from this
	 * CommandBuilder.
	 *
	...
	/**
	 * Sets the {@link bot.utils.command.Command#children children} of the Command built from this
	 * CommandBuilder.
	 *
	...
	/**
	 * Sets the {@link bot.utils.command.Command#helpBiConsumer help BiConsumer} of the Command built
	...
	/**
	 * Sets the Command built to {@link bot.utils.command.Command#usesTopicTags use TopicTags}.
	 *
	...
	/**
	 * Sets the {@link bot.utils.command.Command#cooldownScope cooldown scope} of the Command built
	 * from this CommandBuilder.
	 *
	...
	public CommandBuilder setCooldownScope(CooldownScope cooldownScope) {
		if (cooldownScope == null) this.cooldownScope = CooldownScope.USER;
		else this.cooldownScope = cooldownScope;
		return this;
	}

	/**
	 * Sets the Command built to be {@link bot.utils.command.Command#hidden hidden} from the help
	 * builder.
	 *
	...
	/**
	 * Builds the {@link bot.utils.command.Command Command} using the previously provided information.
	 *
	 * <p>This uses the only the {@link CommandEvent CommandEvent} parameter that
	 * would be provided during {@link bot.utils.command.Command#execute(CommandEvent)
	 * #execute(CommandEvent)}, and no information about the Command can be retrieved using this.
	 *
	 * <p>An alternate method {@link
	 * bot.utils.command.CommandBuilder#build(java.util.function.BiConsumer)} exists if you wish to
	 * retrieve information about the Command built during execution.
	 *
	 ...
	 * Builds the {@link bot.utils.command.Command Command} using the previously provided information.
	 *
	 * <p>This uses the both the {@link CommandEvent CommandEvent} parameter that
	 * would be provided during {@link bot.utils.command.Command#execute(CommandEvent)
	 * #execute(CommandEvent)}, and the Command built when, allowing info on the Command to be
	 * retrieved during execution.
	 *
	 * @param execution The {@link java.util.function.BiConsumer} that runs on {@link
	 *                  bot.utils.command.Command#execute(CommandEvent)}.
	 * @return The Command built
	 */
