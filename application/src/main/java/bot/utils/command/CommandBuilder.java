...
import bot.utils.command.Command.CooldownScope;
 ...
 * CommandClient#addCommand(Command) CommandClient#addCommand(Command)}.
 *
...
public class CommandBuilder {
  ...
  /**
   * Sets the {@link Command#name name} of the Command built from this CommandBuilder.
   *
  ...
  /**
   * Sets the {@link Command#help help} snippet of the Command built from this CommandBuilder.
   *
  ...
  /**
   * Sets the {@link Command#category category} of the Command built from this CommandBuilder.
   *
  ...
  /**
   * Sets the {@link Command#arguments arguments} of the Command built from this CommandBuilder.
   *
  ...
  /**
   * Sets the Command built to be {@link Command#allowedInGuild guild only}.
   *
  ...
  /**
   * Sets the name of a {@link Command#requiredRole required role} to use the Command built from
   * this CommandBuilder.
   *
  ...
  /**
   * Sets the Command built to be {@link Command#ownerCommand owner only}.
   *
  ...
  /**
   * Sets the {@link Command#cooldown cooldown} of the Command built from this CommandBuilder.
   *
  ...
  /**
   * Sets the {@link Command#userPermissions required user permissions} of the Command built from
   * this CommandBuilder.
   *
  ...
  /**
   * Sets the {@link Command#botPermissions required bot permissions} of the Command built from this
   * CommandBuilder.
   *
  ...
  /**
   * Adds a {@link Command#aliases alias} for the Command built from this CommandBuilder.
   *
  ...
  /**
   * Adds {@link Command#aliases aliases} for the Command built from this CommandBuilder.
   *
  ...
  /**
   * Sets the {@link Command#aliases aliases} of the Command built from this CommandBuilder.
   *
  ...
  /**
   * Adds a {@link Command#children child} Command to the Command built from this CommandBuilder.
   *
  ...
  /**
   * Adds {@link Command#children child} Commands to the Command built from this CommandBuilder.
   *
  ...
  /**
   * Sets the {@link Command#children children} of the Command built from this CommandBuilder.
   *
  ...
  /**
   * Sets the {@link Command#helpBiConsumer help BiConsumer} of the Command built from this
   * CommandBuilder.
   *
  ...
  /**
   * Sets the Command built to {@link Command#usesTopicTags use TopicTags}.
   *
  ...
  /**
   * Sets the {@link Command#cooldownScope cooldown scope} of the Command built from this
   * CommandBuilder.
   *
  ...
  /**
   * Sets the Command built to be {@link Command#hidden hidden} from the help builder.
   *
  ...
  /**
   * Builds the {@link Command Command} using the previously provided information.
   *
   * <p>This uses the only the {@link CommandEvent CommandEvent} parameter that would be provided
   * during {@link Command#execute(CommandEvent) #execute(CommandEvent)}, and no information about
   * the Command can be retrieved using this.
   *
   * <p>An alternate method {@link CommandBuilder#build(BiConsumer)} exists if you wish to retrieve
   * information about the Command built during execution.
   *
   ...
   * during {@link Command#execute(CommandEvent) #execute(CommandEvent)}, and the Command built
   * when, allowing info on the Command to be retrieved during execution.
   *
