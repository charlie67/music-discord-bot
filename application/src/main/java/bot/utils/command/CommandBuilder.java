...
public class CommandBuilder {
   ...
   *
   * <p>This uses the only the {@link CommandEvent CommandEvent} parameter that would be provided
   * during {@link bot.utils.command.Command#execute(CommandEvent) #execute(CommandEvent)}, and no
   ...
   * Builds the {@link bot.utils.command.Command Command} using the previously provided information.
   *
   * <p>This uses the both the {@link CommandEvent CommandEvent} parameter that would be provided
   * during {@link bot.utils.command.Command#execute(CommandEvent) #execute(CommandEvent)}, and the
