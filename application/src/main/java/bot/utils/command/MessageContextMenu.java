...
public abstract class MessageContextMenu extends ContextMenu {
  /**
   * Runs checks for the {@link MessageContextMenu} with the given {@link MessageContextMenuEvent}
   * that called it. <br>
   * Will terminate, and possibly respond with a failure message, if any checks fail.
   *
   * @param event The MessageContextMenuEvent that triggered this menu
   */
  ...
  /**
   * The main body method of a {@link MessageContextMenu}. <br>
   * This is the "response" for a successful {@link MessageContextMenu#run(MessageContextMenuEvent)}
   *
   * @param event The {@link MessageContextMenuEvent} that triggered this menu.
   */
