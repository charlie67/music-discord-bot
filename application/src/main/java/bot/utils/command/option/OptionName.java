...
public enum OptionName {
	// play command
	PLAY_AUDIO_SONG_NAME("link-or-query", "URL to play or search term", OptionType.STRING),
	...
	// seek command
	SEEK_POSITION("position", "Position to seek to. e.g. 1:25 for 1 minute and 25 seconds", OptionType.STRING),
	...
	// search alias
	ALIAS_SEARCH_NAME("name", "Name of the alias to search for", OptionType.STRING);
	...
	OptionName(String displayName, String description, OptionType optionType) {
