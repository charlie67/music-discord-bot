...
public @interface JDACommand {
   ...
   *
   * @return An array of strings, the first one being the name of the command, and following ones
   *     being aliases.
   */
  ...
  /**
   * Whether or not the command is only usable in a guild. <br>
   * Default {@code true}.
   *
   * @return {@code true} if the command can only be used in a guild, {@code false} otherwise.
   */
  ...
  /**
   * Whether or not the command is owner only. <br>
   * Default {@code true}.
   *
