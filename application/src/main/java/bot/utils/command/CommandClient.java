...
public interface CommandClient {
   ...
   * other shards join or leave guilds. This means that shards will not always retrieve the same
   * value. For instance:
   *
   * <ul>
   *   <li>1) Shard A joins 10 Guilds
   *   <li>2) Shard B invokes this method
   ...
   * To set your Discord Bots API Key, you'll have to retrieve it from the <a
