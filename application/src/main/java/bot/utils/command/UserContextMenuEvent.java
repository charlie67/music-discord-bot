...
public class UserContextMenuEvent extends UserContextInteractionEvent {
  ...
  public UserContextMenuEvent(
      @NotNull JDA api,
      long responseNumber,
      @NotNull UserContextInteraction interaction,
   ...
   * automatically does {@link ReplyCallbackAction#queue() RestAction#queue()}.
   *
   * <p>This method uses {@link GenericCommandInteractionEvent#replyFiles(FileUpload...)} to send
   * the File. For more information on what a bot may send using this, you may find the info in that
   * method.
   *
