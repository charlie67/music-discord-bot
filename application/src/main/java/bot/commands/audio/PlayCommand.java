...
public class PlayCommand extends Command {
	...
	public PlayCommand(
		...
		this.options =
						List.of(Option.createOption(OptionName.PLAY_AUDIO_SONG_NAME, true, 0));
	...
	protected void execute(CommandEvent event) {
		LOGGER.info(
						"Play command triggered with message {}",
						event.getOption(OptionName.PLAY_AUDIO_SONG_NAME).getAsString());
