...
public class AliasCreateCommand extends Command {
	...
	public AliasCreateCommand(AliasEntityRepository aliasEntityRepository) {
		...
		this.options = List.of(Option.createOption(OptionName.ALIAS_CREATE_NAME, true, 0), Option.createOption(OptionName.ALIAS_CREATE_COMMAND, true, 1), Option.createOption(OptionName.ALIAS_CREATE_ARGS, true, 1));
